                    ...
                    {[
                        {
                            title: "Kente Weaving",
                            tag: "Artistry",
                            img: "https://images.unsplash.com/photo-1596700000000-0a672322394a?q=80&w=800",
                            desc: "Every thread tells a story of royalty, bravery, and ancestral wisdom."
                        },
                        {
                            title: "Jollof & Flavors",
                            tag: "Gastronomy",
                            img: "https://images.unsplash.com/photo-1610000000000-0a672322394a?q=80&w=800",
                            desc: "Taste the soul of West Africa in every bite of our legendary cuisine."
                        },
                        {
                            title: "Rythyms & Dance",
                            tag: "Performance",
                            img: "https://images.unsplash.com/photo-1620000000000-0a672322394a?q=80&w=800",
                        ...
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="glass-card group hover:bg-white/10 transition-all duration-500 overflow-hidden"
                        >
                            ...
                            <div className="p-8">
                                <span className="text-twenty-carat text-xs font-bold uppercase tracking-widest mb-2 block">{item.tag}</span>
